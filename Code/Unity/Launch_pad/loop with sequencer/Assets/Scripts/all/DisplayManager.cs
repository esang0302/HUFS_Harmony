...
public class DisplayManager : MonoBehaviour {
   ...
   private string _ftueSampleRecordText = "";
   private string _ftueSamplePlayText = "";
   private string _ftueSampleStartedRecordingText = "";
   private string _ftueSampleStoppedRecordingText = "";

   private string _ftueMixText = "";

   private string _ftueResetText = "";
