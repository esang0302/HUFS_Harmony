...
{	
	...
	void Start () 
	{
		m_isWhiteKey = transform.parent.gameObject.name == "2C";
		//m_keyColor = GetComponent<Renderer>().material.color;
	...
	void InterpolateKeyMovement ()
	{
		...
		//GetComponent<Renderer>().material.color = Color.Lerp(GetComponent<Renderer>().material.color ,m_targetColor, smooth * Time.deltaTime);
	}
	...
	void OnCollisionEnter(Collision other)
	{
		...
		if(!other.transform.gameObject.name.StartsWith("2C"))
		{
			OnKeyDown();
		}
	}
